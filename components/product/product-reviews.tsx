    ...
    return (
        <div className="mt-12">
            ...
            <div className="flex items-center mb-8">
                ...
                <p className="ml-2 text-lg font-medium text-gray-900">{averageRating.toFixed(1)} out of 5</p>
                    ...
                    reviews.map((review) => (
                        <div key={review.id} className="border-b border-gray-200 pb-6">
                            <div className="flex items-center mb-2">
                                ...
                                <h3 className="ml-2 text-sm font-semibold text-gray-900">{review.user}</h3>
                                <time className="ml-auto text-sm text-gray-500">{review.date}</time>
                            </div>
